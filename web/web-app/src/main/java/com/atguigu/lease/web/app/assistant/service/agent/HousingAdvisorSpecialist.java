...
public class HousingAdvisorSpecialist extends AbstractRoleBoundAssistantSpecialist {

    public HousingAdvisorSpecialist(ChatClient chatClient,
    ...
    public AssistantSpecialistType type() {
        return AssistantSpecialistType.HOUSING_ADVISOR;
    }
    ...
    protected String roleInstructions() {
        return """
                ...
                - 如果问题信息不足，只追问一个最高价值的问题；如果信息已经足够，就不要连环追问。
