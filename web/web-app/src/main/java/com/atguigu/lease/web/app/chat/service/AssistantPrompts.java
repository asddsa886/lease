...
public final class AssistantPrompts {
    ...
    public static final String SYSTEM_MESSAGE = """
            ...
            - 如果用户上一轮已经表达了“预约/取消/改约”的意图，而本轮只补充了缺失信息，例如“明天中午十二点”“就改这个”“取消这条”，要视为继续上一轮任务。
            - 如果上下文里已经有足够的信息定位房源或预约，就直接调用工具；只有在缺少必要参数时，才追问缺失字段。
            - 对创建预约、取消预约、修改预约，不要进入额外的本地确认流程；信息足够就直接调用工具。
            - 对“最新预约”“这条预约”“刚才那条预约”这类说法，优先结合近期上下文；如果上下文不足，再先调用 getMyAppointments 获取最新可操作预约。
